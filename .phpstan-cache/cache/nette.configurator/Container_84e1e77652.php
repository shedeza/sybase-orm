...
class Container_84e1e77652 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_84e1e77652 $container)
			{
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					'/var/www/sybase-orm/src/Command',
					'/var/www/sybase-orm/src/DataCollector',
					'/var/www/sybase-orm/src/DependencyInjection/Configuration.php',
				],
				'analyse' => [],
			]
		);
	...
	public function createServiceContainer(): Container_84e1e77652
	{
		return $this;
	}
