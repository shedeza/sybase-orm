<?php
// source: phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
// source: /var/www/sybase-orm/phpstan.neon
// source: array
...
class Container_62978b1ea0 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/var/www/sybase-orm']);
	}
	...
	public function createService043(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('071'),
			[
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
			],
			['/var/www/sybase-orm']
		);
	}
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				[
					...
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Collection/ArrayCollection.php',
				],
				[
					'message' => '#^Offset \'password\' on array\{host\: string, port\: int, dbname\: string, username\: string, password\: string, charset\: string, persistent\: bool\} in isset\(\) always exists and is not nullable\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Connection/ConnectionManager.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Connection/ConnectionUrlParser.php',
				],
				[
					'message' => '#^Offset \'charset_conversion\' on array\{host\?\: string, port\?\: int, dbname\?\: string, username\?\: string, password\?\: string, charset\?\: string, persistent\?\: bool\} in empty\(\) does not exist\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Connection/ConnectionUrlParser.php',
				],
				[
					'message' => '#^Result of \|\| is always true\.$#',
					'count' => 2,
					'path' => '/var/www/sybase-orm/src/Connection/SqlParameterExpander.php',
				],
				[
					'message' => '#^PHPDoc tag @return with type array\<string, array\<string\>\> is incompatible with native type string\|null\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Metadata/MetadataReader.php',
				],
				[
					'message' => '#^Variable \$pkCols in empty\(\) always exists and is not falsy\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Migration/MigrationManager.php',
				],
				[
					'message' => '#^Variable \$whereParts in empty\(\) always exists and is not falsy\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/ORM/EntityManager.php',
				],
				[
					'message' => '#^Variable \$nonNullValues in empty\(\) always exists and is not falsy\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/ORM/EntityRepository.php',
				],
				[
					'message' => '#^Method SybaseORM\\\ORM\\\PersistentCollection\:\:fromArray\(\) should return SybaseORM\\\ORM\\\PersistentCollection\<T of object\> but returns SybaseORM\\\ORM\\\PersistentCollection\<object\>\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/ORM/PersistentCollection.php',
				],
				[
					'message' => '#^Method SybaseORM\\\Proxy\\\ProxyGenerator\:\:isGetter\(\) is unused\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Proxy/ProxyGenerator.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Query/OqlParser.php',
				],
				[
					'message' => '#^Unreachable statement \- code above always terminates\.$#',
					'count' => 3,
					'path' => '/var/www/sybase-orm/src/Query/OqlPrinter.php',
				],
				[
					'message' => '#^Property SybaseORM\\\Query\\\OqlToSqlTranslator\:\:\$aliasToTable is never read, only written\.$#',
					'count' => 1,
					'path' => '/var/www/sybase-orm/src/Query/OqlToSqlTranslator.php',
				],
				[
					'message' => '#^Unreachable statement \- code above always terminates\.$#',
					'count' => 2,
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_62978b1ea0 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/sybase-orm/.phpstan-cache/resultCache.php',
					...
					null,
					[
						'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					[],
					$fileReplacements,
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/sybase-orm/.phpstan-cache/resultCache.php');
	}
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/var/www/sybase-orm'],
			[
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/var/www/sybase-orm/phpstan.neon',
				'/var/www/sybase-orm/phpstan-baseline.neon',
			],
			null,
			[
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService073(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www/sybase-orm',
			'/var/www/sybase-orm/.phpstan-cache',
			[
				'phar:///var/www/sybase-orm/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'/var/www/sybase-orm/phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('/var/www/sybase-orm');
	}
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('083'),
			[],
			['analyseAndScan' => ['/var/www/sybase-orm/src/Command', '/var/www/sybase-orm/src/DataCollector'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/var/www/sybase-orm');
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/sybase-orm/.phpstan-cache/cache/PHPStan');
	}


	public function createServiceContainer(): Container_62978b1ea0
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/var/www/sybase-orm');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/var/www/sybase-orm');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludes_analyse' => [],
			'excludePaths' => [
				'analyseAndScan' => ['/var/www/sybase-orm/src/Command', '/var/www/sybase-orm/src/DataCollector'],
				'analyse' => [],
			],
			'level' => 5,
			'paths' => ['/var/www/sybase-orm/src'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'memoryLimitFile' => '/var/www/sybase-orm/.phpstan-cache/.memory_limit',
			'tempResultCachePath' => '/var/www/sybase-orm/.phpstan-cache/resultCaches',
			'resultCachePath' => '/var/www/sybase-orm/.phpstan-cache/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => '/var/www/sybase-orm/.phpstan-cache',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/sybase-orm/.phpstan-cache',
			'rootDir' => '/var/www/sybase-orm/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/var/www/sybase-orm',
			...
			'composerAutoloaderProjectPaths' => ['/var/www/sybase-orm'],
