...
│                       # via cached ReflectionClass and ReflectionProperty (per class+property),
│                       # uses ClassMetadata.getColumnByName() for O(1) column lookup,
│                       # integrates TypeCaster + IdentityMap,
