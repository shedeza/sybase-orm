# Documentación — Sybase ORM

Punto de entrada central a toda la documentación del proyecto `shedeza/sybase-orm`.

## Manuales

| Manual | Descripción |
|--------|-------------|
| [Manual de Usuario](./usuario-manual/README.md) | Guía completa de uso: configuración, mapeo, consultas, relaciones, caché y más |
| [Manual de Operación](./manual-operacion/README.md) | Despliegue, optimización, monitoreo y troubleshooting en producción |
| [Manual Técnico](./manual-tecnico/README.md) | Arquitectura interna, patrones de diseño, extensibilidad y contribución |
